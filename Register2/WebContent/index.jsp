...
<body>
	<div class = "container">
		<form method = "post" action = "./userRegister">
			<table class = "table table-bordered table-hover" style= "text-align: center; border : 1px solid #3498db"> 
				<thead>
					<tr>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan ="2"><input class ="form-control" type = "text" id = "userNumber" name = "userNumber" maxLength ="20"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan ="2"><input class ="form-control" type = "email" id = "userEamil" name = "userAge" maxLength ="20"></td>
					</tr>
					<tr>
						<td style = "text-align:left"colspan ="3"><input class ="btn btn-primary pull-right" type ="submit" value ="회원가입"></td> <!-- 내용 전송으로 회원가입 가능하게함-->
					</tr>
				</tbody>
			</table>
		</form>
